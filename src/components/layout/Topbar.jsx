    ...
    <header className="sticky top-0 z-20 border-b border-line bg-canvas/85 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          <button className="focus-ring hidden h-10 w-10 place-items-center rounded-lg border border-line bg-surface text-slate-300 sm:grid" aria-label="Notifications">
            <Bell size={18} />
          </button>
          <div className="hidden rounded-lg border border-line bg-surface px-3 py-2 text-right md:block">
          ...
          <button
            className="focus-ring grid h-10 w-10 place-items-center rounded-lg border border-line bg-surface text-slate-300 hover:text-white"
